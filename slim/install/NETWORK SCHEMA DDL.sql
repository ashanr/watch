...
-- Schema NETWORK
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `zonenolimit_network` DEFAULT CHARACTER SET utf8 ;
USE `zonenolimit_network` ;

-- -----------------------------------------------------
-- Table `NETWORK`.`COUNTRIES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zonenolimit_network`.`COUNTRIES` (
...
-- Table `NETWORK`.`USERS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zonenolimit_network`.`USERS` (
  ...
  CONSTRAINT `fk_USERS_COUNTRIES1`
    ...
    REFERENCES `zonenolimit_network`.`COUNTRIES` (`ID_COUNTRY`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zonenolimit_network`.`QUOTES` (
  ...
  CONSTRAINT `fk_QUOTES_USERS`
    FOREIGN KEY (`ID_USER`)
    REFERENCES `zonenolimit_network`.`USERS` (`ID_USER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `NETWORK`.`LIKES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zonenolimit_network`.`LIKES` (
  `ID_USER` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_LIKES_QUOTES1`
    ...
    REFERENCES `zonenolimit_network`.`QUOTES` (`ID_QUOTE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
