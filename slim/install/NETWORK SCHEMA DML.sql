...
-- -----------------------------------------------------
INSERT INTO `zonenolimit_network`.`COUNTRIES` (`ID_COUNTRY`, `ISO`, `COUNTRY`) VALUES
(1, 'AF', 'Afghanistan'),
(2, 'AL', 'Albania'),
(3, 'DZ', 'Algeria'),
(4, 'AS', 'American Samoa'),
...
-- -----------------------------------------------------
-- Dumping data for table `zonenolimit_network`.`USERS`
-- -----------------------------------------------------
INSERT INTO `zonenolimit_network`.`USERS` (`ID_USER`, `GUID`, `USERNAME`, `PASSWORD`, `CREATED_AT`, `ID_COUNTRY`) VALUES
(0, '', 'ManuelGil', '', '2018-01-01', 1);


-- -----------------------------------------------------
-- Dumping data for table `zonenolimit_network`.`QUOTES`
-- -----------------------------------------------------
INSERT INTO `zonenolimit_network`.`QUOTES` (`ID_QUOTE`, `QUOTE`, `POST_DATE`, `POST_TIME`, `LIKES`, `ID_USER`) VALUES
(0, ''t use classes or a php framework.', '2018-01-01', '00:00:00', 1, 0);
