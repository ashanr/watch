...
//CURLOPT_URL => $opt_url,
        ...
        if ($err) {
            ...
            if (isset($_COOKIE['client_session'])) {
                ...
                if ($account_exipre_date_remaning = 0) {
                    //IF TOKEN EXPIRE DATE  IS OVER GIVE SUBSCRIPTION EXPIRATION MESSAGE
                    echo json_encode(array(array("msgType" => 3, "msg" => "Your Subscription Has Expired")));
                } else if ($new_token_expire_date_remaning >= $account_exipre_date_remaning) {
                    ...
                    setcookie("client_session", $_SESSION['user_name'], time() + $account_exipre_date_remaning * 60 * 60 * 24, "/");
                    echo "New Cookie is set for " . strval($account_exipre_date_remaning) . " days<br />";
                    ...
                    setcookie("client_session", $_SESSION['user_name'], time() + $new_token_expire_date_remaning * 60 * 60 * 24, "/");
